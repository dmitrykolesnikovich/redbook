...
public class Water {
    ...
    public void enableSlowAnimation(boolean enable) {
        slow = enable;
    }
    ...
    public void enableBorderWrapping(boolean enable) {
        wrap = enable;
    }

    public void enableBoundaryApplication(boolean enable) {
        applyInteriorBoundaries = enable;
    }

    public void enableSpinningLogo(boolean enable) {
        spinLogo = enable;
    }
    ...
    public void setBlurDistance(float distance) {
        blurDist = distance;
    ...
    public float getDropFrequency() {
        return dropletFrequency;
    }

    public void setDropFrequency(float frequency) {
        dropletFrequency = frequency;
    }
