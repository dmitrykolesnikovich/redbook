...
public class HWShadowmapsSimple extends Demo {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        switch (displayMode) {
            case RENDER_SCENE_FROM_CAMERA_VIEW:
                render_scene_from_camera_view(gl, drawable, params);
                break;
            case RENDER_SCENE_FROM_CAMERA_VIEW_SHADOWED:
                render_scene_from_camera_view_shadowed(gl, drawable, params);
                break;
            case RENDER_SCENE_FROM_LIGHT_VIEW:
                render_scene_from_light_view(gl, drawable, viewportX, viewportY);
                break;
            default:
                throw new RuntimeException("Illegal display mode " + displayMode);
        }
    }
